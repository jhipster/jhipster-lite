...
public class SpringBoot {
  ...
  public static final String NEEDLE_LOGBACK_LOGGER = "<!-- jhipster-needle-logback-add-logger -->";
  ...
  public static final String LOGGING_TEST_CONFIGURATION = "logback-test.xml";
