...
public class MySQLModuleFactory {
  ...
  private static final String SOURCE_FOLDER = "server/springboot/database/mysql";
  ...
  public JHipsterModule buildModule(JHipsterModuleProperties properties) {
    ...
    DockerImage dockerImage = dockerImages.get("mysql");
  ...
  private void appendContext(JHipsterModuleBuilder builder, JHipsterModuleProperties properties, DockerImage dockerImage) {
    builder
      ...
      .put("srcMainDocker", "src/main/docker") // Used in mysql.md
      .put("mySQLDockerImageWithVersion", dockerImage.fullName()); // Used in mysql.yml
  }

  private void appendDocumentation(JHipsterModuleBuilder builder) {
    builder.documentation(documentationTitle("MySQL"), from(SOURCE_FOLDER).template("mysql.md"));
  }
  ...
  private void appendFiles(JHipsterModuleBuilder builder, JHipsterModuleProperties properties) {
    JHipsterDestination mainDestination = toSrcMainJava()
      ...
      .append("technical/infrastructure/secondary/mysql");

    builder
      .files()
      .add(from(SOURCE_FOLDER).template("DatabaseConfiguration.java"), mainDestination.append("DatabaseConfiguration.java"))
      .add(from(SOURCE_FOLDER).template("mysql.yml"), toSrcMainDocker().append("mysql.yml"));
  }
  ...
  private void appendJavaDependencies(JHipsterModuleBuilder builder) {
    builder
      ...
      .add(groupId("mysql"), artifactId("mysql-connector-java"))
  ...
  private JavaDependency testContainer() {
    return javaDependency()
      ...
      .artifactId(DatabaseType.MYSQL.id())
