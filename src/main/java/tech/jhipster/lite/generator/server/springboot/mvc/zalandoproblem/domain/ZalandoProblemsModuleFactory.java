    ...
    return moduleBuilder(properties)
      ...
      .files()
        .batch(SOURCE.append("main"), toSrcMainJava().append(packagePath).append(EXCEPTION_PATH))
          .template("BadRequestAlertException.java")
          .template("ErrorConstants.java")
          .template("ExceptionTranslator.java")
          .template("FieldErrorDTO.java")
          .template("HeaderUtil.java")
          .template("ProblemConfiguration.java")
          .and()
        .batch(TEST_SOURCE, toSrcTestJava().append(packagePath).append(EXCEPTION_PATH))
          .template("BadRequestAlertExceptionTest.java")
          .template("ExceptionTranslatorIT.java")
          .template("ExceptionTranslatorTestController.java")
          .template("FieldErrorDTOTest.java")
          .template("HeaderUtilTest.java")
          .and()
