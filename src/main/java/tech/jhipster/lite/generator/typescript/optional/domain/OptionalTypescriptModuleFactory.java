  ...
  public JHipsterModule buildModule(JHipsterModuleProperties properties) {
    ...
    return moduleBuilder(properties)
      .packageJson()
        ...
        .addScript(scriptKey("jest"), scriptCommand("jest src/test/javascript/unit --logHeapUsage --maxWorkers=2 --no-cache"))
      ...
      .files()
        ...
        .add(from("typescript/test/javascript/unit/common/domain/optional/").file("Optional.spec.ts"), to("src/test/javascript/unit/common/domain/Optional.spec.ts"))
      .and()
      .build();
    //@formatter:on
  }
