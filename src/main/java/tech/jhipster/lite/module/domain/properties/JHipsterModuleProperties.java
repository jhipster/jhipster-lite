...
public class JHipsterModuleProperties {
  ...
  public JHipsterModuleProperties(String projectFolder, boolean commitModule, Map<String, Object> parameters) {
    ...
    configurationFormat = SpringConfigurationFormat.from(this.parameters.getOrDefault(SERVER_CONFIGURATION_FORMAT, SpringConfigurationFormat.YAML.get(), String.class));
  }
