Feature: Vue.js modules
  ...
  Scenario: Should apply vue core module
    When I apply "vue" module to default project with package json without parameters
    Then I should have files in "src/main/webapp/app/http"
      | AxiosHttp.ts |
    
  Scenario: Should apply pinia module
    Given I apply "vue" module to default project with package json without parameters
