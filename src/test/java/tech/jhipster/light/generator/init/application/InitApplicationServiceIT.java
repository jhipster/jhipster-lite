package tech.jhipster.light.generator.init.application;

import static tech.jhipster.light.TestUtils.*;
import static tech.jhipster.light.generator.init.application.InitAssertFiles.*;
...
class InitApplicationServiceIT {
  ...
  void shouldInitWithConfig() {
    ...
    Map<String, Object> config = new HashMap<>(
      Map.of(
        BASE_NAME, "jhipsterLight",
        PROJECT_NAME, "JHipster Light",
    ...
    assertFileContent(project, "README.md", "JHipster Light");
    assertFileContent(project, "package.json", "jhipster-light");
