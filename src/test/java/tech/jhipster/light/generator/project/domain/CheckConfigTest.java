...
class CheckConfigTest {
  ...
  void shouldValidPackageName() {
    assertThatCode(() -> CheckConfig.validPackageName("tech.jhipster.light")).doesNotThrowAnyException();
  }

  @Test
  void shouldNotValidPackageNameWithSpace() {
    assertThatThrownBy(() -> CheckConfig.validPackageName("tech jhipster light")).isExactlyInstanceOf(UnauthorizedValueException.class);
  }
