...
import tech.jhipster.lite.generator.client.vite.react.cypress.domain.CypressViteReact;
import tech.jhipster.lite.generator.project.domain.Project;

public class CypressViteReactAssert {

  private CypressViteReactAssert() {}

  public static void assertDependency(Project project) {
    CypressViteReact.devDependencies().forEach(devDependency -> assertFileContent(project, PACKAGE_JSON, DQ + devDependency + DQ));
  }
