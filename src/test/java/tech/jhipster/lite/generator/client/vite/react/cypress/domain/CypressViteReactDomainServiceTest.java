...
class CypressViteReactDomainServiceTest {

  @InjectMocks
  CypressViteReactDomainService cypressViteReactDomainService;
  ...
  void shouldAddCypress() {
    ...
    cypressViteReactDomainService.init(project);
  ...
  void shouldNotInit() {
    ...
    assertThatThrownBy(() -> cypressViteReactDomainService.init(project)).isExactlyInstanceOf(GeneratorException.class);
  }
  ...
  void shouldNotAddDevDependencies() {
    ...
    assertThatThrownBy(() -> cypressViteReactDomainService.addDevDependencies(project)).isExactlyInstanceOf(GeneratorException.class);
  }
}
