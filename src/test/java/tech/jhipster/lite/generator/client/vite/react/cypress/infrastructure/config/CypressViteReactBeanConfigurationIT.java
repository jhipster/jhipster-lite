...
@IntegrationTest
class CypressViteReactBeanConfigurationIT {
  ...
  @Test
  void shouldGetBean() {
    assertThat(applicationContext.getBean("cypressViteReactService")).isNotNull().isInstanceOf(CypressViteReactDomainService.class);
  }
}
