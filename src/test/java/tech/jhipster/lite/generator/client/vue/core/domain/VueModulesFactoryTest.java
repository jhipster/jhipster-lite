...
class VueModulesFactoryTest {
  ...
  void shouldCreateVueModule() {
    ...
    assertThatModuleWithFiles(module, packageJsonFile(), lintStagedConfigFile())
      ...
      .hasPrefixedFiles("src/test/javascript/unit/http", "AxiosHttp.spec.ts", "AxiosHttpStub.ts", "AxiosStub.ts")
      ...
      .hasFiles("src/test/javascript/unit/common/primary/app/App.spec.ts")
      ...
      .hasFile("src/main/webapp/app/common/primary/homepage/Homepage.component.ts")
        ...
        .and()
      .hasFiles("src/test/javascript/unit/common/primary/homepage/Homepage.spec.ts")
      .hasFiles("src/main/webapp/app/router/router.ts", "src/test/javascript/unit/router/Router.spec.ts")
      ...
      .hasFiles("src/test/javascript/unit/common/domain/Logger.fixture.ts")
      .hasFiles("src/test/javascript/unit/common/secondary/ConsoleLogger.spec.ts")
      .hasFiles("src/main/webapp/app/vue/VueProp.ts")
      .hasFiles(
        "src/test/javascript/unit/vue/vue-prop/ArrayComponentVue.vue",
        "src/test/javascript/unit/vue/vue-prop/ObjectComponentVue.vue",
        "src/test/javascript/unit/vue/vue-prop/VueProp.spec.ts"
      );
    //@formatter:on
  }
