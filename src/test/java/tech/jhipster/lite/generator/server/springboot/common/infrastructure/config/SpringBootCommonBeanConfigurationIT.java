...
@IntegrationTest
class SpringBootCommonBeanConfigurationIT {
  ...
  @Test
  void shouldGetBean() {
    assertThat(applicationContext.getBean("springBootCommonService")).isNotNull().isInstanceOf(SpringBootCommonDomainService.class);
  }
}
