...
@IntegrationTest
class SpringBootWebfluxBeanConfigurationIT {
  ...
  @Test
  void shouldGetBean() {
    assertThat(applicationContext.getBean("springBootWebfluxService")).isNotNull().isInstanceOf(SpringBootWebfluxDomainService.class);
  }
}
